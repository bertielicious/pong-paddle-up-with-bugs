...
void setup_ports(void)
{
    ...
    CM1CON1 = 0x00;
    CM2CON1 = 0x00;
    TRISAbits.TRISA4 = HIGH;  // paddle left(up) input pin 3
    TRISAbits.TRISA5 = HIGH;  // player 1/2 selection input pin 2
    TRISBbits.TRISB4 = LOW;   // override SPI functionality SDI as it is not needed
    TRISBbits.TRISB6 = LOW;   // SCK is an output pin 11
    TRISCbits.TRISC2 = HIGH;  // paddle right (down) input pin 14
